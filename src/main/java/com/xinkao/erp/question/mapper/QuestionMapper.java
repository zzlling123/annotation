...
public interface QuestionMapper extends BaseMapper<Question> {
    ...
    List<Question> getRandQuestion(@Param("examPageSetType") ExamPageSetType examPageSetType, @Param("difficultyLevel") Integer difficultyLevel,@Param("symbol")  List<String> symbol);
}

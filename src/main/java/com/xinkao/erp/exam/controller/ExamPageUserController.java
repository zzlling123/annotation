...
public class ExamPageUserController {
    ...
    @ApiOperation("获取试卷信息")
    public BaseResponse<ExamUserVo> getExamUserInfo(@RequestParam @Valid ExamUserQuery examUserQuery) {
    ...
    @ApiOperation("获取答题进度")
    public BaseResponse<List<ExamProgressVo>> getExamUserProgress(@RequestParam @Valid ExamUserQuery examUserQuery) {
